    ...
    async function chargerSupportsDepuisSupabase() {
        try {
            ...
            baseSupports = data;
            console.log("Nom exact de la clé chantier :", Object.keys(baseSupports[0]).find(k => k.toLowerCase() === 'chantier'));
            console.log("Valeur du chantier pour la 1ère ligne :", baseSupports[0].chantier || baseSupports[0].Chantier || baseSupports[0].CHANTIER);
